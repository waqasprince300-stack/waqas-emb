...
/**
 * PLMobileCards — Renders the card-list view for mobile Party Ledger.
 * Pure render component — all data and callbacks come from props.
 */
export default function PLMobileCards({
  filtered,
  paginatedLots,
  ledgerPartyEdits,
  isParty,
            ...
            <div key={`pl-mob-${l.id}`} className="party-ledger-mobile-card">
              <div className="pl-mob-header">
                <div>
                  ...
                  {l.designNo ? <span style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-secondary, #475569)' }}> &middot; Design #{l.designNo}</span> : null}
                </div>
                <div>
